...
import radon_circ_gpu_processing
from tifffile import imsave
from PIL import Image


# Radon-transzformáció elvégzése circ() bázisfüggvény segítségével, az eredmény vizualizálásával.
if __name__ == '__main__':
    ...
    sinogram = radon_circ_gpu_processing.radon_transform(data, angles_degrees, side_length)
