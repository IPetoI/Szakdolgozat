...
import radon_rect_cpu_processing
from tifffile import imsave
from PIL import Image


# Radon-transzformáció elvégzése rect() bázisfüggvény segítségével, az eredmények vizualizálásával.
if __name__ == '__main__':
    ...
    sinogram = radon_rect_cpu_processing.radon_transform(image_array, angles_degrees, show_radon_process)
